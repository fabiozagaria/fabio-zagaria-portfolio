...
def build_cv():
    ...
    projects = [
        (
            "<b>Backend Studenti</b> | <i>In corso</i> | Java 21, Spring Boot, Spring JDBC, MySQL",
            [
        ...
        (
            "<b>Gestionale Spese</b> | <i>In sviluppo</i> | Angular, TypeScript",
            [
                "Realizzata un'app web per inserimento, modifica e riepilogo delle spese con componenti riutilizzabili e servizi dedicati.",
                "Implementati Reactive Forms, validazioni frontend e aggiornamento dinamico dei riepiloghi.",
            ],
        ),
        (
            "<b>FakeFlicks</b> | 2026 | HTML, CSS, JavaScript",
            [
                "Sviluppata un'interfaccia responsive stile catalogo streaming con rendering dinamico e separazione tra dati, logica e UI.",
            ],
        ),
        (
            "<b>Portfolio personale</b> | 2026 | Angular, TypeScript, GitHub, Vercel",
            [
                "Creato e pubblicato un sito responsive per presentare percorso, competenze, documenti e progetti.",
            ],
        ),
    ]
